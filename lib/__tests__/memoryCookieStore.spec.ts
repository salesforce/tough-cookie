...
describe('MemoryCookieStore', () => {
  ...
  it('should have instance methods that return promises', () => {
    ...
    expect(memoryCookieStore.findCookie("example.com", "/", "key")).toBeInstanceOf(Promise);
    expect(memoryCookieStore.findCookies("example.com", "/")).toBeInstanceOf(Promise);
    expect(memoryCookieStore.putCookie(new Cookie())).toBeInstanceOf(Promise);
    expect(memoryCookieStore.updateCookie(new Cookie(), new Cookie())).toBeInstanceOf(Promise);
    expect(memoryCookieStore.removeCookie("example.com", "/", "key")).toBeInstanceOf(Promise);
    expect(memoryCookieStore.removeCookies("example.com", "/")).toBeInstanceOf(Promise);
